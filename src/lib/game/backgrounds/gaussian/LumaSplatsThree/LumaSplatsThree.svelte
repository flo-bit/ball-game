<script lang="ts">
	...
	const LumaSplatsThree = LumaWeb.LumaSplatsThree;
	...
	export let source: LumaWeb.LumaSplatsSource;
	...
	const splats = suspend(
		asyncWritable(
			remember(() => {
				return new Promise<[LumaWeb.LumaSplatsThree, CubeTexture | undefined]>((resolve) => {
